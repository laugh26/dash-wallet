...
public class SampleActivity extends Activity {
    ...
    private static final String[] DONATION_ADDRESSES_MAINNET = {
            "XxB4BUKEYzuUAk4PC8fhfdC2yQe9EPAm8G",  //Hash Engineering donation  address
    ...
    private static final String WALLET_URI_SCHEME = "tiajianswallet";
    ...
    private void sendInterAppCommunicationRequest(Uri requestUri, int requestCode) {
        ...
        if (componentName != null) {
            ...
            Toast.makeText(this, "Tiajians Wallet not installed", Toast.LENGTH_LONG).show();
        }
    }
